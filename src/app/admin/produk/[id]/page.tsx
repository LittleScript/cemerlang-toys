...
export default async function AdminProdukEditPage(props: PageProps<"/admin/produk/[id]">) {
  ...
  return (
    <div>
      ...
      <a href={`/admin/produk/${id}/komersial`} className="mt-2 inline-block text-sm font-semibold text-ct-teal-dark hover:underline">Kelola harga group, packaging, MOQ, dan alias →</a>
